...
import { useGetPublicTemplates, useGetTemplate, useGetTemplateData } from "@/queries/templates";
...
export const TemplateViewerPage = () => {
		...
		return (
			<div className="min-h-screen bg-sidebar overflow-x-hidden">
				...
				<main className="flex flex-col items-center justify-center gap-3 px-6 pt-32 pb-20 text-center">
					...
					/>
					<p className="text-sm font-medium text-foreground">Template not found</p>
					<Link to="/templates">
	...
	return (
		<>
			<TemplateViewer template={template} templateData={templateData} />
			{related.length ? (
